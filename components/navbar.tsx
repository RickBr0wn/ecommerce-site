...
const Navbar = () => {
	return (
		<nav className='flex flex-col  md:flex-row md:justify-between text-gray-600 '>
			{/* Logo */}
			...
			{/* Links */}
			<div className='flex justify-center md:ml-auto items-center'>
				<Link href='/'>
				...
				<Link href='/'>
					<a className=' bg-purple-600 hover:bg-purple-700 text-gray-50 hover:text-purple-600 p-2 px-4 rounded-full flex'>
						<svg
